...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/darklost/auto_shell/master/shadowsocks_install/shadowsocks-libev-debian"
}
...
install_shadowsocks(){
    ...
    if [ $? -eq 0 ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks-libev install failed. please visit https://darklost.me/358.html and contact."
        exit 1
    fi
    ...
    echo
    echo "Welcome to visit:https://darklost.me/358.html"
    echo "Enjoy it!"
    echo
}
